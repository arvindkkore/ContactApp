...
fun readCallLog(context:Context):Single<MutableList<CallModel>> {
val single:Single<MutableList<CallModel>> =Single.create<MutableList<CallModel>>{
    emitter -> fetchData(context)
}
return single
}
