...
class RecievedCallAdapter(val context: Context, val list: MutableList<CallModel>) : RecyclerView.Adapter<RecievedCallAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.imageView_type.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.ic_call_received))
