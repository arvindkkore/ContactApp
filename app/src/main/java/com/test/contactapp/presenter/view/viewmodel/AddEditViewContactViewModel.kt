...
@ActivityScope
class AddEditViewContactViewModel @Inject constructor(val context: Context, val addContact: AddContact, val getContactFromDB: GetContactFromDB, val getLookupData: GetLookupData) : ViewModel()
{

    companion object {
        val TAG ="AddEditContactViewModel"
    }
