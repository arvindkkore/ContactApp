...
import com.test.contactapp.data.util.readContacts
import com.test.contactapp.presenter.adapter.CustomAdapter
...
class ContactFragmentNew : Fragment(), OnItemClick {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        thread { readContacts(this.activity?.application as Context) }
        ...
        if(contactsCursor !=null && contactsCursor.moveToFirst())
        {
           do {
               ...
               if (dataCursor != null && dataCursor.moveToFirst()) {
                   displayName = dataCursor  .getString(
                           dataCursor
                               .getColumnIndex(ContactsContract.Contacts.DISPLAY_NAME)
                       )// get
                   // the
