...
import com.test.contactapp.presenter.view.ui.fragments.CallFragmentNew
import com.test.contactapp.presenter.view.ui.fragments.ContactFragmentNew
import com.test.contactapp.presenter.view.ui.fragments.HomeFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nav_view.setNavigationItemSelectedListener { menuItem ->
            ...
            when(menuItem.itemId){
                 R.id.nav_share ->{}
                 R.id.nav_report_bug ->{
                     startActivity(Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:support@coccus.app")))}
            }
